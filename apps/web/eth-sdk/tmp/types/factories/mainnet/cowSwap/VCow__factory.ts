...
import type { VCow, VCowInterface } from '../../../mainnet/cowSwap/VCow'
...
export class VCow__factory {
  ...
  static createInterface(): VCowInterface {
    return new Interface(_abi) as VCowInterface
  }
  static connect(address: string, runner?: ContractRunner | null): VCow {
    return new Contract(address, _abi, runner) as unknown as VCow
  }
}
