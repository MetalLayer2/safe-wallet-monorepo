...
export interface WxdaiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'name'
      | 'approve'
...
export interface Wxdai extends BaseContract {
  connect(runner?: ContractRunner | null): Wxdai
  attach(target: string | Addressable): Wxdai
