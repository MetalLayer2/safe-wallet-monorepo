...
import { createDefaultTxFlow, SubmitCallbackWithData } from '../../createTxFlow'
...
const ChangeThresholdFlow = () => {
  ...
  return (
    <TxFlow initialData={{ threshold }} icon={SaveAddressIcon} subtitle="Change threshold" onSubmit={handleSubmit}>
      <ChooseThreshold />
    </TxFlow>
  )
}
