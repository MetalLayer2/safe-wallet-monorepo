...
import useLoadPolicies from '@/features/policies/hooks/loadables/useLoadPolicies'
...
import { policiesSlice } from '@/features/policies/store/policiesSlice'
...
const useLoadableStores = () => {
  ...
  useUpdateStore(policiesSlice, useLoadPolicies)
}
